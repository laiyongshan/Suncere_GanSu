...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle){
        ...
        selectedTextColor=ta.getColor(R.styleable.segmentcontrol_selectTextColor,Color.parseColor("#9ac8fa"));
        unselectedTextColor=ta.getColor(R.styleable.segmentcontrol_unselectTextColor,Color.WHITE);
...
//        mPaint.setColor(Color.parseColor("#EA2000"));
